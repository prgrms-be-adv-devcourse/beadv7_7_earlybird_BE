...
class SecurityConfigTest {
    ...
    private static Stream<Arguments> roleGatedRoutes() {
        return Stream.of(
                ...
                Arguments.of(HttpMethod.GET, "/api/v1/users/creator-applications", List.of(UserRole.ADMIN)),
                Arguments.of(HttpMethod.POST, "/api/v1/users/creator-applications/1/approve", List.of(UserRole.ADMIN)),
                Arguments.of(HttpMethod.POST, "/api/v1/users/creator-applications/1/reject", List.of(UserRole.ADMIN)),
