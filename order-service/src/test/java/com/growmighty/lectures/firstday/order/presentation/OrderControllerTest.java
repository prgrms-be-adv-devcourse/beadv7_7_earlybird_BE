...
//                "김하나한", "010-0000-0000", "서울시 강남구", "06236")));
//
//        mockMvc.perform(get("/internal/v1/orders/me").param("userId", "1"))
//                .andExpect(status().isOk())
//                .andExpect(jsonPath("$.success").value(true))
...
//                "김하나한", "010-0000-0000", "서울시 강남구", "06236"));
//
//        mockMvc.perform(get("/internal/v1/orders/1"))
//                .andExpect(status().isOk())
//                .andExpect(jsonPath("$.success").value(true))
//                .andExpect(jsonPath("$.data.id").value(1));
//    }
...
//
//        mockMvc.perform(get("/internal/v1/orders/999"))
...
//        when(orderApiService.cancelOrder(1L, 1L))
//                .thenThrow(new IllegalStateException("이미 취소된 주문입니다."));
//
//        mockMvc.perform(post("/internal/v1/orders/1/cancel").param("userId", "1"))
