...
public class ChatClientConfig {
    ...
    private static final String GUARDRAIL_SYSTEM_PROMPT = """
        ...
        search_projects/browse_projects 결과에서 totalCount는 0보다 큰데 projects 리스트가 비어있다면,
        실제로 프로젝트가 없는 게 아니라 이 대화에서 이미 전부 보여드렸다는 뜻이야 - "추천할 프로젝트가 없다"거나
        "프로젝트 정보가 없다"고 말하지 말고, "지금 진행 중인 프로젝트는 이미 다 보여드렸어요" 같은 취지로
        정확하게 안내해.
