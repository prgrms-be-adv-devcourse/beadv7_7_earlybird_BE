...
@Import({NoticeRepositoryAdapter.class, JpaAuditingConfig.class})
class NoticeRepositoryTest {
    ...
    void saveAndFindById() {
        ...
        ProjectNotice found = noticeRepository.findById(saved.getId()).orElseThrow();
    ...
    void findByIdReturnsDeletedNotice() {
        ...
        ProjectNotice found = noticeRepository.findById(notice.getId()).orElseThrow();
    ...
    class FindVisibleByProjectId {
        ...
        void excludesDeleted() {
            ...
            List<ProjectNotice> result = noticeRepository.findVisibleByProjectId(PROJECT_ID);
