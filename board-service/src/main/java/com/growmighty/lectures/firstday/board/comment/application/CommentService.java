...
public class CommentService {
    ...
    @Transactional
    public Comment register(Long projectId, Long userId, String authorName, String content) {
        return commentRepository.save(Comment.create(CommentTargetType.PROJECT, projectId, userId, authorName, content));
    }

    @Transactional
    public Comment registerReply(Long parentId, Long userId, String authorName, String content) {
        Comment parent = commentRepository.findById(parentId)
            .orElseThrow(() -> new EntityNotFoundException("존재하지 않는 의견입니다. commentId=" + parentId));
        return commentRepository.save(Comment.reply(parent, userId, authorName, content));
    }
